...
import { Map, Wifi } from "@mui/icons-material";
    ...
    <div className="Darkbackground" style={{ marginTop: "50px" }}>
      <Grid container>
        ...
        <Grid container spacing={10} style={{ display: "flex" }}>
          {housing.map((housing) => (
            <Grid item xs={12} sm={4} key={housing.complexId}>
              <Box
                sx={{
                  my: 10,
                  mx: 4,
                    ...
                    <Grid container spacing={2}>
                      ...
                      >
                        <Map
                          ...
                          onClick={() => {
                            window.open(housing.mapsLink, "_blank");
                          }}
                        />
                        <p
                          style={{
                    ...
                    >
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                          <CardActions>
                            <Link
                              href={`/complex-details/${housing.complexId}`}
                            >
                              <Button
                                variant="contained"
                                style={{ fontSize: "10px" }}
